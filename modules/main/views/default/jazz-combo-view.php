...
$this->title = Yii::t('app', 'JAZZ_COMBO_PAGE_TITLE') . ' - ' . $model->name;

$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'JAZZ_COMBO_PAGE_TITLE'), 'url' => ['jazz-combo']];
$this->params['breadcrumbs'][] = $this->title;
\yii\web\YiiAsset::register($this);
?>

<div class="jazz-combo-view">
    <h1><?= $model->name ?></h1>
