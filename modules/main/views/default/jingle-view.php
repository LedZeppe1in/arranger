...
$this->title = Yii::t('app', 'JINGLE_PAGE_TITLE');
?>

<!-- Breadcrumbs Section -->
<section class="breadcrumbs-custom bg-image context-dark" style="background-image: url(/web/images/breadcrumbs-jingle.jpg);">
    <div class="container">
        <h3 class="breadcrumbs-custom-title"><?= $this->title ?></h3>
        <pre-footer-classic class="breadcrumbs-custom-subtitle">
            <?= Yii::t('app', 'JINGLE_PAGE_TEXT') ?>
        </pre-footer-classic>
    </div>
</section>
    ...
    <div class="container">
        <div class="row row-50 justify-content-between">
            <div class="col-md-7">
                ...
                <?= Html::a(Yii::t('app', 'BUTTON_VIEW_MORE_INFO'), ['/main/default/jingles'],
