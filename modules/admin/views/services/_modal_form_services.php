...
Modal::begin([
    'id' => 'removeServiceModalForm',
    'header' => '<h3>' . Yii::t('app', 'SERVICES_ADMIN_PAGE_DELETE_SERVICE') . '</h3>',
]); ?>

    <div class="modal-body">
        <p style="font-size: 14px">
            <?php echo Yii::t('app', 'SERVICES_ADMIN_PAGE_MODAL_FORM_TEXT'); ?>
        </p>
    </div>
    ...
    <?php $form = ActiveForm::begin([
        ...
        'method' => 'post',
        'action' => ['/services/delete/' . $model->id],
